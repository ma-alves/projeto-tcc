            ...
            <form action="processa_altera_pac.php" method="post">
                ...
                <div class="form-group with-icon">
                    ...
                    <div class="input-container">
                        ...
                        <input type="text" name="telefone" value="<?php echo "$registro[1]"; ?>" class="form-control" maxlength="11" minlength="11" required>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <a href="exibe_pac.php?id=<?php echo $id ?>" class="action-btn btn-cancel">Cancelar</a>
                </div>
            </form>
        </div>
    </section>
